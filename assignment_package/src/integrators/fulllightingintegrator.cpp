...
float FullLightingIntegrator::BalanceHeuristic(int nf, Float fPdf, int ng, Float gPdf) const
{
...
float FullLightingIntegrator::PowerHeuristic(int nf, Float fPdf, int ng, Float gPdf) const
{
...
bool FullLightingIntegrator::RussianRoulette(Color3f& energy, float probability, int depth) const
{
